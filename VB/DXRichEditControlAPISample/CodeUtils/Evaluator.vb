...
Namespace DXRichEditControlAPISample
    ...
    Public MustInherit Class ExampleCodeEvaluator
        ...
        Public Function ExecuteCodeAndGenerateDocument(ByVal args As DXRichEditControlAPISample.CodeEvaluationEventArgs) As Boolean
        ...
        Protected Friend Function CompileAndRun(ByVal linesOfCode As String(), ByVal evaluationParameter As Object) As Boolean
            ...
            Dim referencesSystem As String() = New String() {"System.dll", "System.Windows.dll", "System.Windows.Forms.dll", "System.Data.dll", "System.Xml.dll", "System.Core.dll", "System.Drawing.dll", "System.Xaml.dll", "WindowsBase.dll", "PresentationFramework.dll", "PresentationCore.dll"}
    ...
    Public MustInherit Class RichEditExampleCodeEvaluator
        Inherits DXRichEditControlAPISample.ExampleCodeEvaluator
...
#Region "RichEditCSExampleCodeEvaluator"
    Public Class RichEditCSExampleCodeEvaluator
        Inherits DXRichEditControlAPISample.RichEditExampleCodeEvaluator

        Protected Overrides Function GetCodeDomProvider() As CodeDomProvider
            Return New Microsoft.CSharp.CSharpCodeProvider()
        End Function

        Const codeStartField As String = "using System;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using DevExpress.XtraRichEdit;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using DevExpress.XtraRichEdit.API.Native;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using DevExpress.Xpf.RichEdit;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using DevExpress.Office.Utils;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.Drawing;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.Windows;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using DevExpress.Utils;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.IO;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.Diagnostics;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.Xml;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.Data;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.Collections.Generic;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.Linq;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.Globalization;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "using System.Windows.Resources;" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "namespace RichEditCodeResultViewer { " & Global.Microsoft.VisualBasic.Constants.vbCrLf & "public class ExampleItem { " & Global.Microsoft.VisualBasic.Constants.vbCrLf & "        public static void Process(Document document) { " & Global.Microsoft.VisualBasic.Constants.vbCrLf & Global.Microsoft.VisualBasic.Constants.vbCrLf
        ...
        Protected Overrides ReadOnly Property CodeStart As String
            Get
                Return DXRichEditControlAPISample.RichEditCSExampleCodeEvaluator.codeStartField
            End Get
        End Property

        Protected Overrides ReadOnly Property CodeBeforeClasses As String
            Get
                Return DXRichEditControlAPISample.RichEditCSExampleCodeEvaluator.codeBeforeClassesField
            End Get
        End Property

        Protected Overrides ReadOnly Property CodeEnd As String
            Get
                Return DXRichEditControlAPISample.RichEditCSExampleCodeEvaluator.codeEndField
            End Get
        End Property
    End Class
...
#Region "RichEditVbExampleCodeEvaluator"
    Public Class RichEditVbExampleCodeEvaluator
        ...
        Const codeStartField As String = "Imports Microsoft.VisualBasic" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports DevExpress.XtraRichEdit" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports DevExpress.XtraRichEdit.API.Native" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System.Drawing" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports DevExpress.Office.Utils" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System.Windows" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports DevExpress.Utils" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System.IO" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System.Diagnostics" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System.Xml" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System.Data" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System.Collections.Generic" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System.Globalization" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Imports System.Windows.Resources" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Namespace RichEditCodeResultViewer" & Global.Microsoft.VisualBasic.Constants.vbCrLf & Global.Microsoft.VisualBasic.Constants.vbTab & "Public Class ExampleItem" & Global.Microsoft.VisualBasic.Constants.vbCrLf & Global.Microsoft.VisualBasic.Constants.vbTab & Global.Microsoft.VisualBasic.Constants.vbTab & "Public Shared Sub Process(ByVal document As Document)" & Global.Microsoft.VisualBasic.Constants.vbCrLf & Global.Microsoft.VisualBasic.Constants.vbCrLf
        ...
        Protected Overrides ReadOnly Property CodeStart As String
            Get
                Return DXRichEditControlAPISample.RichEditVbExampleCodeEvaluator.codeStartField
            End Get
        End Property

        Protected Overrides ReadOnly Property CodeBeforeClasses As String
            Get
                Return DXRichEditControlAPISample.RichEditVbExampleCodeEvaluator.codeBeforeClassesField
            End Get
        End Property

        Protected Overrides ReadOnly Property CodeEnd As String
            Get
                Return DXRichEditControlAPISample.RichEditVbExampleCodeEvaluator.codeEndField
            End Get
        End Property
    End Class
...
#End Region
    Public MustInherit Class ExampleEvaluatorByTimer
        ...
        Private leakSafeCompileEventRouter As DXRichEditControlAPISample.LeakSafeCompileEventRouter
        ...
        Public Sub New(ByVal enableTimer As Boolean)
            Me.leakSafeCompileEventRouter = New DXRichEditControlAPISample.LeakSafeCompileEventRouter(Me)
            If enableTimer Then
                Me.compileExampleTimer = New System.Windows.Forms.Timer()
                Me.compileExampleTimer.Interval = DXRichEditControlAPISample.ExampleEvaluatorByTimer.CompileTimeIntervalInMilliseconds
...
#Region "Events"
        Public Event QueryEvaluate As DXRichEditControlAPISample.CodeEvaluationEventHandler
        ...
        Protected Friend Overridable Function RaiseQueryEvaluate() As CodeEvaluationEventArgs
            If QueryEvaluateEvent IsNot Nothing Then
                Dim args As DXRichEditControlAPISample.CodeEvaluationEventArgs = New DXRichEditControlAPISample.CodeEvaluationEventArgs()
        ...
        Public Event OnAfterCompile As DXRichEditControlAPISample.OnAfterCompileEventHandler

        Private Sub RaiseOnAfterCompile(ByVal result As Boolean)
            RaiseEvent OnAfterCompile(Me, New DXRichEditControlAPISample.OnAfterCompileEventArgs() With {.Result = result})
        End Sub

#End Region
        Public Sub CompileExample(ByVal sender As Object, ByVal e As System.EventArgs)
            If Not Me.compileComplete Then Return
            Dim args As DXRichEditControlAPISample.CodeEvaluationEventArgs = Me.RaiseQueryEvaluate()
            If Not args.Result Then Return
            Me.ForceCompile(args)
        End Sub

        Public Sub ForceCompile(ByVal args As DXRichEditControlAPISample.CodeEvaluationEventArgs)
        ...
        Private Sub CompileExampleAndShowPrintPreview(ByVal args As DXRichEditControlAPISample.CodeEvaluationEventArgs)
        ...
        Public Function Evaluate(ByVal args As DXRichEditControlAPISample.CodeEvaluationEventArgs) As Boolean
            Dim richeditExampleCodeEvaluator As DXRichEditControlAPISample.ExampleCodeEvaluator = Me.GetExampleCodeEvaluator(args.Language)
            Return richeditExampleCodeEvaluator.ExecuteCodeAndGenerateDocument(args)
        End Function

        Protected MustOverride Function GetExampleCodeEvaluator(ByVal language As DXRichEditControlAPISample.ExampleLanguage) As ExampleCodeEvaluator
...
#Region "RichEditExampleEvaluatorByTimer"
    Public Class RichEditExampleEvaluatorByTimer
        Inherits DXRichEditControlAPISample.ExampleEvaluatorByTimer

        Public Sub New()
            MyBase.New()
        End Sub

        Protected Overrides Function GetExampleCodeEvaluator(ByVal language As DXRichEditControlAPISample.ExampleLanguage) As ExampleCodeEvaluator
            If language = DXRichEditControlAPISample.ExampleLanguage.VB Then Return New DXRichEditControlAPISample.RichEditVbExampleCodeEvaluator()
            Return New DXRichEditControlAPISample.RichEditCSExampleCodeEvaluator()
        End Function
    End Class
...
#Region "LeakSafeCompileEventRouter"
    Public Class LeakSafeCompileEventRouter
        ...
        Public Sub New(ByVal [module] As DXRichEditControlAPISample.ExampleEvaluatorByTimer)
        ...
        Public Sub OnCompileExampleTimerTick(ByVal sender As Object, ByVal e As System.EventArgs)
            Dim [module] As DXRichEditControlAPISample.ExampleEvaluatorByTimer = CType(Me.weakControlRef.Target, DXRichEditControlAPISample.ExampleEvaluatorByTimer)
    ...
    Public Delegate Sub CodeEvaluationEventHandler(ByVal sender As Object, ByVal e As DXRichEditControlAPISample.CodeEvaluationEventArgs)
    ...
    Public Delegate Sub OnAfterCompileEventHandler(ByVal sender As Object, ByVal e As DXRichEditControlAPISample.OnAfterCompileEventArgs)
#End Region
End Namespace

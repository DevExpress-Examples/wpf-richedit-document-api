    ...
    Public MustInherit Class ExampleFinder
        ...
        Public Function ParseSourceFileAndFindRegionsWithExamples(ByVal groupName As String, ByVal sourceCode As String) As List(Of CodeExample)
            ...
            For Each match In matches
                ...
                Dim splitter As String = If(matchString.IndexOf(Microsoft.VisualBasic.Constants.vbCrLf) >= 0, Microsoft.VisualBasic.Constants.vbCrLf, Microsoft.VisualBasic.Constants.vbLf)
        ...
        Protected Function CreateRichEditExample(ByVal exampleGroup As String, ByVal regionName As String, ByVal exampleCode As String) As CodeExample
            ...
            result.HumanReadableGroupName = ConvertStringToMoreHumanReadableForm(exampleGroup)
            Return result
        End Function
        ...
        Protected Overridable Function ValidateRegionName(ByVal lines As String(), ByRef regionName As String) As Boolean
            ...
            If regionIndex = 0 Then
                isHelper = True
                regionName = ConvertStringToMoreHumanReadableForm(region.Substring(regionIndex + RegionHelperStartPattern.Length + keepHashMark))
            End If
            ...
            If regionIndex < 0 Then
                ...
                regionName = ConvertStringToMoreHumanReadableForm(region.Substring(regionIndex + RegionStartPattern.Length + keepHashMark))
            End If
...
'#Region "ExampleFinderVB"
    Public Class ExampleFinderVB
        ...
        Protected Overrides Function DeleteLeadingWhiteSpacesFromSourceCode(ByVal lines As String()) As String()
            ...
            Return CodeExampleDemoUtils.DeleteLeadingWhiteSpaces(result, Microsoft.VisualBasic.Constants.vbTab & Microsoft.VisualBasic.Constants.vbTab)
        End Function

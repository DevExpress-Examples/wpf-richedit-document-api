...
#Region "#AddFloatingPicture"
            ...
            Dim streamResInfo As System.Windows.Resources.StreamResourceInfo = System.Windows.Application.GetResourceStream(New System.Uri("beverages.png", System.UriKind.Relative))
            If streamResInfo IsNot Nothing Then
                Using s As System.IO.Stream = streamResInfo.Stream
                    Dim myPicture As DevExpress.XtraRichEdit.API.Native.Shape = document.Shapes.InsertPicture(document.CreatePosition(15), DevExpress.XtraRichEdit.API.Native.DocumentImageSource.FromStream(s))

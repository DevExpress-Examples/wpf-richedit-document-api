...
Namespace DXRichEditControlAPISample.CodeExamples
    ...
    Public Module NotesActions
        ...
        Private Sub InsertFootnotes(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
...
#End Region  ' #InsertFootnotes 
        ...
        Private Sub InsertEndnotes(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
...
#End Region  ' #InsertEndnotes
        ...
        Private Sub EditFootnote(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
#Region "#EditFootnote"
            document.LoadDocument("Documents//Grimm.docx")
...
#End Region  ' #EditFootnote
        ...
        Private Sub EditEndnote(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
#Region "#EditEndnote"
            document.LoadDocument("Documents//Grimm.docx")
...
#End Region  ' #EditEndnote
        ...
        Private Sub EditSeparator(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
...
#End Region  ' #EditSeparator
        ...
        Private Sub RemoveNotes(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
#Region "#RemoveNotes"
            document.LoadDocument("Documents//Grimm.docx")

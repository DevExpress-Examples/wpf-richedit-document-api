...
#Region "#ChangeColumnAppearance"
            ...
            table.ForEachRow(New DevExpress.XtraRichEdit.API.Native.TableRowProcessorDelegate(AddressOf DXRichEditControlAPISample.CodeExamples.TableActions.ChangeColumnAppearanceHelper.ChangeColumnColor))
            table.EndUpdate()
...
#Region "#ChangeTableColor"
            ...
            table.ForEachCell(New DevExpress.XtraRichEdit.API.Native.TableCellProcessorDelegate(AddressOf DXRichEditControlAPISample.CodeExamples.TableActions.TableHelper.ChangeCellColor))
            table.ForEachCell(New DevExpress.XtraRichEdit.API.Native.TableCellProcessorDelegate(AddressOf DXRichEditControlAPISample.CodeExamples.TableActions.TableHelper.ChangeCellBorderColor))
            table.EndUpdate()
...
#Region "#UseTableCellProcessor"
            ...
            table.BeginUpdate()
            table.ForEachCell(New DevExpress.XtraRichEdit.API.Native.TableCellProcessorDelegate(AddressOf DXRichEditControlAPISample.CodeExamples.TableActions.UseTableCellProcessorHelper.MakeMultiplicationCell))
            table.EndUpdate()
...
#End Region  ' #@UseTableCellProcessor
        Private Shared Sub MergeCells(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
#Region "#MergeCells"
...
#End Region  ' #SplitCells
        ...
        Private Shared Sub DeleteTableElements(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
...
#End Region  ' #DeleteTableElements
        ...
        Private Shared Sub DeleteTable(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
#Region "#DeleteTable "
            Dim tbl As DevExpress.XtraRichEdit.API.Native.Table = document.Tables.Create(document.Range.Start, 3, 4)
        'To delete the table, uncomment the method below:
        '  document.Tables.Remove(tbl);
#End Region  ' #DeleteTable
        End Sub

        Private Shared Sub WrapTextAroundTable(ByVal document As DevExpress.XtraRichEdit.API.Native.Document)
